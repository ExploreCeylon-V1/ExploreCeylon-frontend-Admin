...
export default function BulkActionBar({ count, onClear, actions }) {
  ...
  return (
    <div className="flex flex-wrap sm:flex-nowrap items-center justify-between gap-3 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 mb-4">
      ...
      <button onClick={onClear} className="ml-auto text-emerald-700 hover:text-emerald-900 shrink-0">
        <X size={16} />
      </button>
    </div>
  );
